...
config_snow_copy = open('/Users/KB/Desktop/snowflake_project/Snowpark_pipeline/config/copy_to_snowstg_avro_v1.json', "r")
config_snow_copy = json.loads(config_snow_copy.read())

connection_parameter = open('/Users/KB/Desktop/snowflake_project/Snowpark_pipelineconfig/connection_details.json', "r")
